...
void init_growatt124(sProtocolDefinition_t &Protocol) {
  ...
  // FEAGMENT 1: BEGIN
  Protocol.InputRegisters[P124_PV1_POWER]           = sGrowattModbusReg_t{   5, 0, SIZE_32BIT, "PowerPV1", 0.1, POWER_W, true, false};  // #5
  Protocol.InputRegisters[P124_PV2_POWER]           = sGrowattModbusReg_t{   9, 0, SIZE_32BIT, "PowerPV2", 0.1, POWER_W, true, false};  // #8
  ...
  Protocol.InputRegisters[P124_SOC]                 = sGrowattModbusReg_t{1014, 0, SIZE_16BIT, "BatteryPercent", 1, PRECENTAGE, true, true};  // #34
  Protocol.InputRegisters[P124_PAC_TO_USER_TOTAL]   = sGrowattModbusReg_t{1021, 0, SIZE_32BIT, "PowerGridImport", 0.1,  POWER_W, true, false};  // #36
  Protocol.InputRegisters[P124_PAC_TO_GRID_TOTAL]   = sGrowattModbusReg_t{1029, 0, SIZE_32BIT, "PowerGridExport",0.1,  POWER_W, true, false};  // #38
  Protocol.InputRegisters[P124_PLOCAL_LOAD_TOTAL]   = sGrowattModbusReg_t{1037, 0, SIZE_32BIT, "PowerHouseCurrent", 0.1,  POWER_W, true, false};  // #40 
